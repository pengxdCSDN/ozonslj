  ...
  return (
    <div className="view-content">
      ...
      <section className="panel import-panel keyword-import-panel">
        <div className="keyword-import-guide"><div><p className="eyebrow">使用说明</p><h2>把搜索词报告变成可分析数据</h2><p>先告诉系统每一列代表什么，再上传或粘贴报告；预览通过后才会保存批次，重复文件会自动复用。</p></div><ol><li><strong>映射字段</strong><span>对应关键词、搜索量和转化率列名</span></li><li><strong>导入数据</strong><span>选择 XLSX，或粘贴 CSV（二选一）</span></li><li><strong>预览提交</strong><span>确认行数和样本后写入导入历史</span></li></ol></div>
