...
export function DataQualityDashboardView({ workspaceId }: { workspaceId: string }) {
  ...
  return <div className="view-content">
    ...
    <section className="panel quality-summary-panel">
    ...
    <section className="panel quality-findings-panel"><div className="panel-heading"><h2>开放问题与影响字段</h2><span className="status-pill warning">{findings.length} 条待处理</span></div>
