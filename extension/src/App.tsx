...
export function App() {
  ...
  return <main className="app-shell">
    ...
    {view === "listing-publish" && active ? <div className="controlled-execution-stack"><ListingPublishView workspaceId={selectedWorkspaceId} /><DiffPreviewView workspaceId={selectedWorkspaceId} /><DataFreshnessView workspaceId={selectedWorkspaceId} /><DataProvenanceView workspaceId={selectedWorkspaceId} /><RelationshipQualityView workspaceId={selectedWorkspaceId} /><MoneyInventoryQualityView workspaceId={selectedWorkspaceId} /><SourceConflictView workspaceId={selectedWorkspaceId} /><QualityIsolationView workspaceId={selectedWorkspaceId} /><PriceBatchView /><ExecutionResultsView workspaceId={selectedWorkspaceId} /><ReadbackVerificationView workspaceId={selectedWorkspaceId} /><AuditEventsView workspaceId={selectedWorkspaceId} /><ManualApprovalView workspaceId={selectedWorkspaceId} /></div> : null}
