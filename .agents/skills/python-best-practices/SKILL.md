...
description: Python software engineering guidelines from real PR review patterns, customized for Simplified Chinese comments and docstrings. This skill should be used when writing, reviewing, or refactoring Python code — especially dataclasses, service interfaces, error handling, type annotations, and developer documentation. Triggers on tasks involving Python modules, API design, data modeling, type safety, exception handling, comments, docstrings, or refactoring for maintainability.
license: MIT
metadata:
...
Guidelines for writing and reviewing Python. 71 rules across 8 categories, prioritized by impact.
...
- `imports-chinese-comments` — 新增或修改的 Python 注释与文档字符串使用简体中文
